 ...
 * @author Will Vasquez
 */
public class FrmVIP extends javax.swing.JDialog {
String mark2;
    /**
     * Creates new form FrmVIP
     * @param parent
     * @param modal
     */
    public FrmVIP(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Vehiculos VIP");
        setLocationRelativeTo(null);
        ((JPanel)getContentPane()).setOpaque(false); 
        ImageIcon uno=new ImageIcon(this.getClass().getResource("/Diseño/vip.jpg")); 
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblPicture, javax.swing.GroupLayout.DEFAULT_SIZE, 319, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void BtnEscogerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEscogerActionPerformed
        if(lblcodigo.getText() == null){
            ...
            try {
                ...
                if(pregunta == 0){
                    PreparedStatement st = cn.prepareStatement("SELECT marca + ', ' + modelo FROM vip WHERE codigo_vip = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmVIP.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmVIP dialog = new FrmVIP(new javax.swing.JFrame(), true);
