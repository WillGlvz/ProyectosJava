 ...
 * @author Will Vasquez
 */
public class FrmNuevoComercial extends javax.swing.JDialog {

    /**
     * Creates new form FrmNuevoComercial
     * @param parent
     * @param modal
     */
    public FrmNuevoComercial(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        setTitle("Vehiculos comerciales");
        ((JPanel)getContentPane()).setOpaque(false); 
        ImageIcon uno=new ImageIcon(this.getClass().getResource("/Diseño/Comercial2.jpg")); 
    ...
    private void BtnAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnAgregarActionPerformed
        if (txtmarca.getText().trim().equals("") || txtmodelo.getText().trim().equals("") || txtaño.getText().trim().equals("") || txtprecioalquiler.getText().trim().equals("") || txtpreciovehiculo.getText().trim().equals("")) {
            ...
            try {
                String url = "\\no_disponible.png";
                PreparedStatement st = cn.prepareStatement("SELECT placa FROM comercial WHERE placa = ?");
                ...
                if(rs.next()){
                    ...
                    st = cn.prepareStatement("INSERT INTO comercial VALUES(?, ?, ?, ?, ?, ?, ?, ?, 0)");
                    ...
                    MostrarDatos();
                    st = cn.prepareStatement("SELECT MAX(codigo_comercial) FROM comercial");
                    ResultSet rs3 = st.executeQuery();
                    rs3.next();
                    txtcodigo.setText(rs3.getString(1));
                    if (lblPicture.getIcon() != null){
                        String destino = (new File("ImagenesComercial")).getAbsolutePath() + "\\" + txtcodigo.getText() + ".png";
                        ...
                        st = cn.prepareStatement("UPDATE comercial SET foto = ? WHERE codigo_comercial = ?");
                        st.setString(1, url);
    ...
    private void BtnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEliminarActionPerformed
        if(txtcodigo.getText().isEmpty()){
            ...
            try {
                PreparedStatement st = cn.prepareStatement("DELETE FROM comercial WHERE codigo_comercial = ?");
                ...
                if(eliminar == 0){
                    st.execute();
                    String UbicacionImagen = (new File("ImagenesComercial")).getAbsolutePath() + "\\" + txtcodigo.getText() + ".png";
    ...
    private void BtnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnModificarActionPerformed
        if (txtmarca.getText().trim().equals("") || txtmodelo.getText().trim().equals("") || txtaño.getText().trim().equals("") || txtprecioalquiler.getText().trim().equals("") || txtpreciovehiculo.getText().trim().equals("")) {
            ...
            try {
                ...
                PreparedStatement st = cn.prepareStatement("UPDATE comercial SET placa = ?, marca = ?, modelo = ?, año = ?, precio_vehiculo = ?, precio_alquiler = ?, foto = ? WHERE codigo_comercial = ?");
                st.setString(1, txtmatricula.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmNuevoComercial.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmNuevoComercial dialog = new FrmNuevoComercial(new javax.swing.JFrame(), true);
