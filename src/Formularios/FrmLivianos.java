 ...
 * @author Will Vasquez
 */
public class FrmLivianos extends javax.swing.JDialog {
String mark;
    /**
     * Creates new form FrmLivianos
     * @param parent
     * @param modal
     */
    public FrmLivianos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        setTitle("Vehiculos livianos");
        setLocationRelativeTo(null);
        ((JPanel)getContentPane()).setOpaque(false); 
        ImageIcon uno=new ImageIcon(this.getClass().getResource("/Diseño/Livianos.jpg")); 
            ...
            public void valueChanged(ListSelectionEvent event) {
                try {
                    ...
                    try {
                        ...
                        try {
                            JOptionPane.showMessageDialog(null, "¡La imagen del vehiculo sido eliminada, considere modificarla!", "AVISO", JOptionPane.ERROR_MESSAGE);
    ...
    private void BtnEscogerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEscogerActionPerformed
        if(lblcodigo.getText() == null){
            ...
            try {
                ...
                if(pregunta == 0){
                PreparedStatement st = cn.prepareStatement("SELECT marca + ', ' + modelo FROM liviano WHERE codigo_liviano = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmLivianos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmLivianos dialog = new FrmLivianos(new javax.swing.JFrame(), true);
